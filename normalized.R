library(DESeq2)
featurecounts_data <- read.table("gene_counts.txt", header = TRUE, row.names = 1, sep = "\t")
...
count_data <- read.table("filtered_featurecounts_output.txt", header = TRUE, row.names = 1, sep = "\t")
